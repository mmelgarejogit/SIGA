...
{
    Task<Result<IEnumerable<TurnoResponse>>> GetAllAsync(DateOnly? fecha, int? professionalId, string? estado, int? patientId = null, DateOnly? desde = null, DateOnly? hasta = null);
