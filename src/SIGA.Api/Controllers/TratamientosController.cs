...
[Authorize]
public class TratamientosController(ITratamientoService service) : BaseController
{
    [HttpGet]
    ...
    [HttpPut("{id:int}")]
    [Authorize(Policy = "gestionar_inventario")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateTratamientoRequest request)
    {
