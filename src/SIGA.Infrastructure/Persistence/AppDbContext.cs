...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    public DbSet<TipoAjuste> TiposAjuste => Set<TipoAjuste>();
    public DbSet<AjusteManual> AjustesManual => Set<AjusteManual>();
    public DbSet<Transferencia> Transferencias => Set<Transferencia>();
    public DbSet<TransferenciaLinea> TransferenciaLineas => Set<TransferenciaLinea>();
    public DbSet<ParametroStock> ParametrosStock => Set<ParametroStock>();
    public DbSet<InventarioFisico> InventariosFisicos => Set<InventarioFisico>();
    public DbSet<InventarioFisicoLinea> InventarioFisicoLineas => Set<InventarioFisicoLinea>();
    ...
    public DbSet<EgresoPago> EgresosPagos => Set<EgresoPago>();
